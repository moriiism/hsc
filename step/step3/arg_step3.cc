...
void ArgValStep3::Init(int argc, char* argv[])
{
    progname_ = "step3";
...
void ArgValStep3::Print(FILE* fp) const
{
...
void ArgValStep3::SetOption(int argc, char* argv[], option* long_options)
{
    if(0 < g_flag_verbose){
        MPrintInfo("start...");
    }
...
void ArgValStep3::Usage(FILE* fp) const
{
    fprintf(fp,
